-- (c) Roberto Ierusalimschy, MIT License, unknown year

-- http://stackoverflow.com/questions/19984291/pure-lua-hashing-method
...
-- Written by Roberto Ierusalimschy, and licensed under MIT
-- http://lua-users.org/wiki/SecureHashAlgorithm

--[[
  edits by lossycrypt, 2018
    + commented out unused sha244 sections
