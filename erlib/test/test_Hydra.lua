...
--[[ lossycrypt, 2020
    ...
    Source:
      /t/test.lua from https://github.com/pkulchenko/serpent
  
    Changes:

      + removed io.stdin "userdata as key" check
...
-- -------------------------------------------------------------------------- --
local serpent = elreq('erlib/lua/Coding/Hydra')()
...
-- -------------------------------------------------------------------------- --
  ...
  local a = {
    ...
    --[[lossycrypt: factorio does not allow _ENV.io]]
...
-- end
  ...
  --[[lossycrypt: not erlib print format]]
  -- print("All tests passed.")

  --[[lossycrypt: arg -> index nil value (don't need perf testing anyway)
...
-- -------------------------------------------------------------------------- --
-- end of serpent_test.lua                                                    --
-- -------------------------------------------------------------------------- --

  

  say('  TESTR  @  erlib.Hydra → Ok')
  -- say('  TESTR  @  erlib.Hydra → Ok (needs more tests)')
...
-- End                                                                        --
-- -------------------------------------------------------------------------- --
do (STDOUT or log or print)('  Loaded → erlib.test_Hydra') end
